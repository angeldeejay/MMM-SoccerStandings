(function registerCanonicalViewAdapter(globalScope) {
	function buildFixtureViewModel(fixture) {
		...
		return {
			...
			homeTeam: fixture && fixture.home && fixture.home.name ? fixture.home.name : "",
			awayTeam: fixture && fixture.away && fixture.away.name ? fixture.away.name : "",
			homeLogo:
				fixture &&
				fixture.home &&
				fixture.home.logos &&
			...
			awayScore:
				fixture && fixture.score && fixture.score.away != null
					...
					: undefined,
			venue:
				fixture && fixture.venue && fixture.venue.name ? fixture.venue.name : "",
			location:
				fixture && fixture.venue && fixture.venue.name ? fixture.venue.name : "",
	...
	globalScope.CanonicalViewAdapter = {
		buildStandingsViewModel(payload, currentLeague) {
			const rows =
				payload &&
				payload.standings &&
				Array.isArray(payload.standings.rows)
			...
			return {
				...
				fixtures:
					payload &&
					payload.fixtures &&
					Array.isArray(payload.fixtures.items)
		...
		buildGroupedStandingsViewModel(payload, currentLeague) {
			...
			(
				...
				groups[groupEntry.id] = (Array.isArray(groupEntry.rows)
					? groupEntry.rows
					: []
				).map((row) => ({
					position: row.rank,
			...
			Object.keys(canonicalKnockouts).forEach((stageKey) => {
				knockouts[stageKey] = (Array.isArray(canonicalKnockouts[stageKey])
